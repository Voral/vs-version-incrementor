...
';
    ...
    public function testOtherMainBranchHideDoubles(): void
    {
        $versionAfter = '';
        $versionAfterExpected = '2.3.0';
...
';
    ...
    public function testOtherMainBranchShowDoubles(): void
    {
        $versionAfter = '';
        $versionAfterExpected = '2.3.0';
...
';
    ...
    public function testDebugWithNoCommit(): void
    {
        $textChangelogExpected = '
...
';
    ...
    public function testUpdateVersionNoCommit(): void
    {
        $expectedOutput = <<<'TEXT'
...
';
        ...
        $config = new Config();
        $config->setVcsExecutor($gitExecutor);
        $updater = new SemanticVersionUpdater('/test', $config, doCommit: false);
        ob_start();
        $updater->updateVersion();
        $output = ob_get_clean();
        self::assertSame($versionAfterExpected, $versionAfter);
